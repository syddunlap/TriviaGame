$(document).ready(function () {
    ...
    let questionArray = ["Sailing is an Olympic sport. What year was it first included in the Olympics?",
    ...
    let answerArray = [["1896", "1904", "1920", "1944"],
    ...
    let userCorrect = "Correct!!!";
    let userIncorrect = "Incorrect!";
    let timerOut = "You're out of time!!!";
    // Variable to hold the explanation when user selects the wrong answer or runs out of time:
    let answerExplain = ["Sailing was introduced into the Olympics at the Games held in Athens, Greece in 1896. Although sailing was on the program for that year it could not take place because of weather concerns. Sailing was not included in the 1900 Olympics, but returned to the regular program in 1904.",
    ...
    let giphyArray = ["<img class='giphy' src='https://media.giphy.com/media/jGC37Ky8b5OxO/giphy.gif'>",
    ...
    let timeUpGif = "<img class='giphy' src='https://media.giphy.com/media/DcshtTtOSpPO/giphy.gif'>";
    ...
    // Logic for what happens when an answer option is clicked
    ...
    // This runs the next question in the array & is called on when the response timer is out of time.
    function next() {
        if (question < 8) {
            $("#response").hide();
            question++;
